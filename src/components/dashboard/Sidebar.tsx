...
export function Sidebar({ activeTab, setActiveTab, userRole, isAdmin, userEmail, unreadNotifications, mobileOpen, setMobileOpen }: SidebarProps) {
    ...
    return (
        <>
            ...
            <div className={cn(
                "w-64 bg-slate-950 h-screen flex flex-col fixed left-0 top-0 border-r border-white/5 shadow-[20px_0_60px_rgba(0,0,0,0.6)] z-50 overflow-hidden transition-transform duration-300 ease-in-out md:translate-x-0",
